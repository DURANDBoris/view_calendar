...
import 'package:visual_calendar/views/CalendarPage.dart';
import 'package:visual_calendar/views/NavigationRailWidget.dart';
import 'package:visual_calendar/views/TaskPage.dart';
                    ...
                    child: Container(
                      ...
                      child: () {
                        switch (viewProvider.page) {
                          case 0:
                            return TaskPage(context: context);
                          case 1:
                            return CalendarPage(
                                context: context, provider: viewProvider);
                          case 2:
